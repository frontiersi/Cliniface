#ifndef FACE_APP_SHARED_PLUGIN_SECOND_ORDER_MAX_CURVATURE_VIS_H
#define FACE_APP_SHARED_PLUGIN_SECOND_ORDER_MAX_CURVATURE_VIS_H
...
class plugins_3dfast_curvature_EXPORT SecondOrderMaxCurvature : public FaceTools::VisualisationAction
{ Q_OBJECT
public:
    SecondOrderMaxCurvature();
